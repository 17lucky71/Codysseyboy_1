...
* [자동화_도구_비교_보고서.md](./automation-pipeline/자동화_도구_비교_보고서.md): Make vs Zapier 기능, 요금제, UI/UX 및 실행 로그 비교 분석
* [AI_연동_자동화_파이프라인_설계.md](./automation-pipeline/02_AI_연동_자동화_파이프라인_설계.md): Gmail 수신 ➡️ OpenAI 요약/분류 ➡️ 조건 분기 ➡️ Discord/Google Sheets 자동화 구현  
